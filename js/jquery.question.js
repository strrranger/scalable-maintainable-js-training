;(function ( $, window, document, undefined ) {
    ...
    function Questions( element, options ) {
    ...
    Questions.prototype._loadData = function(){
        this.questionsData = [
            {
    ...
    Questions.prototype._showNextQuestionOrResult = function(){
        if(this.questionsData.length){
            var currentQuestion = this.questionsData.shift();
            this._showQuestion(currentQuestion);
        }
        else
            this.options.onComplete(this.points);
    }

    Questions.prototype._showQuestion = function(question){
        var self = this;
        this.element.html('');
        var questionDiv = $('<div>');
        ...
        $.each(question.answers, function(i, value){
            questionsUl.append($('<li><input type="radio" name="question" value="'+question.points[i]+'">'+answer+'</li>'));
        });
        questionsUl.find('input').click(function(){
            self.points += $(this).val();
            self._showNextQuestionOrResult();
        });
        this.element.append(questionDiv);
    }
